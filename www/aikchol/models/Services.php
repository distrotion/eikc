...
class Services extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['th_title', 'en_title', 'location', 'th_thumb_image', 'en_thumb_image', 'th_panorama_image', 'en_panorama_image', 'th_image', 'en_image', 'show_first', 'index_weight', 'active', 'update_time', 'create_time'], 'required'],
