    ...
    <div class="row">
        <div class="col-md-3 hidden-xs hidden-sm">
            ...
            <ul class="sub_cat_list">
                ...
                <li><a href="<?= Yii::$app->urlManager->createUrl(['site/vision'])?>" class="sub_cat_active"><?= Yii::t('app', 'Menu_Vision')?></a></li>
        ...
        <div class="col-sm-12 col-md-9">
            <span class="bread_crumb light">
                <a href="<?= Yii::$app->urlManager->createUrl(['site/about'])?>"><?= Yii::t('app', 'Menu_About')?></a> > <span class="active_page"><?= Yii::t('app', 'Menu_Vision')?></span>
            ...
            <h3 class="article_name"><?= Yii::t('app', 'Vision_Title')?></h3>

            <p class="artile_main_text">
                <?= Yii::t('app', 'Vision_Desc')?>
            </p>
            
            <br><br>
            <img src="images/about/<?= Yii::t('app', 'Vision_Slogan')?>.jpg" class="img-responsive" alt="">                 
        </div>
    </div>
