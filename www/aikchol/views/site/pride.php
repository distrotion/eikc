    ...
    <div class="row">
        <div class="col-md-3 hidden-xs hidden-sm">
            ...
            <ul class="sub_cat_list">
                ...
                <li><a href="<?= Yii::$app->urlManager->createUrl(['site/pride'])?>" class="sub_cat_active"><?= Yii::t('app', 'Menu_Pride')?></a></li>
                <li><a href="<?= Yii::$app->urlManager->createUrl(['site/csr'])?>"><?= Yii::t('app', 'Menu_CSR')?></a></li>
            </ul>
        </div>
        <div class="col-sm-12 col-md-9">
            <span class="bread_crumb light">
                <a href="<?= Yii::$app->urlManager->createUrl(['site/about'])?>"><?= Yii::t('app', 'Menu_About')?></a> > <span class="active_page"><?= Yii::t('app', 'Menu_Pride')?></span>
            ...
            <h3 class="article_name"><?= Yii::t('app', 'Pride_Title')?></h3>

            <p class="artile_main_text">
                <?= Yii::t('app', 'Pride_Desc')?>
            </p>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="article_main_img">
                <img src="images/about/awards.jpg" alt="">
            </div>
        </div>
    </div>
