...
{
    const SCENARIO_CREATE = "create_package";
    const SCENARIO_UPDATE = "update_package";
    const IMAGE_PATH = "../aikchol/web/images/package/";
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['th_title', 'en_title', 'location', 'th_thumb_image', 'en_thumb_image', 'th_image', 'en_image', 'show_first', 'index_weight', 'active', 'update_time', 'create_time'], 'required', 'on' => self::SCENARIO_CREATE],
