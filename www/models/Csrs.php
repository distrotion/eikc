...
{
    const SCENARIO_CREATE = "create_csr";
    const SCENARIO_UPDATE = "update_csr";
    ...
    {
        return [
            [['th_title', 'en_title', 'th_thumb_image', 'en_thumb_image', 'th_panorama_image', 'en_panorama_image', 'show_about', 'index_weight', 'active', 'update_time', 'create_time'], 'required', 'on'=> self::SCENARIO_CREATE],
            [['th_title', 'en_title', 'show_about', 'index_weight', 'active', 'update_time', 'create_time'], 'required', 'on'=> self::SCENARIO_UPDATE],
