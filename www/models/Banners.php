...
{
    const SCENARIO_CREATE = "create_banner";
    const SCENARIO_UPDATE = "update_banner";
    const IMAGE_PATH = "../aikchol/web/images/banner/";
    ...
    {
        return [
            [['th_title', 'en_title', 'th_desc', 'en_desc', 'th_link_text', 'en_link_text', 'th_center_image', 'en_center_image', 'th_image', 'en_image', 'link', 'index_weight', 'active', 'update_time', 'create_time'], 'required', 'on' => self::SCENARIO_CREATE],
            [['th_title', 'en_title', 'th_desc', 'en_desc', 'th_link_text', 'en_link_text', 'link', 'index_weight', 'active', 'update_time', 'create_time'], 'required', 'on' => self::SCENARIO_UPDATE],
